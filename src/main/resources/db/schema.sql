...
(
    ...
    age_limit_id        varchar(255)             NOT NULL REFERENCES age_limits (name)
);
...
(
    ...
    country_id varchar(255)       NOT NULL REFERENCES countries (code)
);
...
(
    id           bigint PRIMARY KEY       NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1),
    name         varchar(255)             NOT NULL,
    filmmaker_id bigint                   NOT NULL REFERENCES filmmakers (id) on delete cascade on update cascade,
    film_id      bigint                   NOT NULL REFERENCES films (id),
    insert_date  timestamp with time zone NOT NULL DEFAULT current_timestamp,
    update_date  timestamp with time zone,
    status       varchar(255)             NOT NULL
...
(
    ...
    place_id          bigint                   NOT NULL REFERENCES seats (id)
);
